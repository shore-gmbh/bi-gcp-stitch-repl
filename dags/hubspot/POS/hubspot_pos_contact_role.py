...
def query_bigquery(ti):
    ...
    query = """
                     with hcf as (
                                        select vid, company_id , organization_id, email,
                                        djangoid__pos
                                ...
                                join employee_emails ee
                                                ...
                                                select vid, permission_level as role_in_organization__pos___permission_level_ 
                                                from pos_final_output where djangoid__pos is not null
                                                and djangoid__pos != ''
                                             and upper(djangoid__pos) != 'X'
    """
...
with DAG(
    'hubpost_pos_contact_role',
    default_args=default_args,
    description='hubspot pos contact role',
