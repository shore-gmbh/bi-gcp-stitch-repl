...
SHEET_RANGE = 'KA Orgs'  # or whatever range you wish to fetch

GCS_BUCKET_NAME = 'key_accounts'
GCS_OBJECT_NAME = 'ka_orgs.csv'
BIGQUERY_DATASET_NAME = 'suppl'
BIGQUERY_TABLE_NAME = 'ka_orgs'
...
# Initialize the DAG
with DAG(
    'key_accounts_ka_orgs',
    default_args=default_args,
    description='Key accounts org',
    ...
    load_data = GCSToBigQueryOperator(
            ...
            destination_project_dataset_table='suppl.ka_orgs',
            skip_leading_rows=1,
