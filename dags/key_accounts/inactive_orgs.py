...
SHEET_RANGE = 'Inactive Orgs'  # or whatever range you wish to fetch

GCS_BUCKET_NAME = 'key_accounts'
GCS_OBJECT_NAME = 'inactive_orgs.csv'
BIGQUERY_DATASET_NAME = 'suppl'
BIGQUERY_TABLE_NAME = 'inactive_orgs'
...
# Initialize the DAG
with DAG(
    'key_accounts_inactive_orgs',
    default_args=default_args,
    description='Key accounts inactive org',
    ...
    load_data = GCSToBigQueryOperator(
            ...
            destination_project_dataset_table='suppl.inactive_orgs',
            skip_leading_rows=1,
