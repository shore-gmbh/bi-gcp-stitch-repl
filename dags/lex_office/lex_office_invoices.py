...
dag = DAG(
    ...
    description='Lex office invoices ',
...
def transform_and_insert_to_bq(**kwargs):
    ...
    desired_order = ['id', 'voucherType', 'voucherStatus', 'voucherNumber', 'voucherDate',
       'createdDate', 'updatedDate', 'dueDate', 'contactId', 'contactName',
       'totalAmount', 'openAmount', 'currency', 'archived']      
...
MAX_BATCHES_ESTIMATE = 7  # Adjust this value based on your expectation
